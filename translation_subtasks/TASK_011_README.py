...
自动生成的翻译子任务脚本
任务ID: TASK_011
源文件: /app/Context-Engineering/00_COURSE/01_context_retrieval_generation/README.md
目标文件: /app/Context-Engineering/cn/00_COURSE/01_context_retrieval_generation/README.md
...
# 任务信息
TASK_ID = "TASK_011"
SOURCE_FILE = Path("/app/Context-Engineering/00_COURSE/01_context_retrieval_generation/README.md")
TARGET_FILE = Path("/app/Context-Engineering/cn/00_COURSE/01_context_retrieval_generation/README.md")
TOTAL_SEGMENTS = 1
