...
自动生成的翻译子任务脚本
任务ID: TASK_060
源文件: /app/Context-Engineering/00_COURSE/10_orchestration_capstone/README.md
目标文件: /app/Context-Engineering/cn/00_COURSE/10_orchestration_capstone/README.md
章节: 10_orchestration_capstone
段落数: 1
"""
...
# 任务信息
TASK_ID = "TASK_060"
SOURCE_FILE = Path("/app/Context-Engineering/00_COURSE/10_orchestration_capstone/README.md")
TARGET_FILE = Path("/app/Context-Engineering/cn/00_COURSE/10_orchestration_capstone/README.md")
TOTAL_SEGMENTS = 1
